...
#define D_WEB_SS_ORDER_LABEL        "Orden"
#define D_WEB_SS_CYCLE              "Ciclo en orden de lista"
#define D_WEB_SS_SHUFFLE            "Aleatorio"
#define D_WEB_SS_USE_SINGLE         "Usar un solo salvapantallas"
#define D_WEB_SS_USE_MULTI          "Usar varios salvapantallas"
#define D_WEB_SS_FILES_HEADING      "Archivos de salvapantallas"
#define D_WEB_SS_ADD_ROTATION       "Agregar a la rotación"
#define D_WEB_SS_REMOVE             "&#10005; Quitar"
#define D_WEB_SS_SINGLE_LABEL       "Imagen personalizada única"
...
#define D_WEB_SLEEP_ERR_SIZE        "La imagen debe ser 3904 bytes o un múltiplo entero (fotogramas concatenados)"
#define D_WEB_SLEEP_ERR_TOO_MANY_FRAMES "Demasiados fotogramas (máximo 16)"
#define D_WEB_SLEEP_ERR_EMPTY_CHOOSE "Elija una imagen primero."
#define D_WEB_SLEEP_ERR_ROTATION_SIZE "La imagen de rotación debe ser exactamente 3904 bytes"
#define D_WEB_SLEEP_ERR_NO_FREE_SLOT "No hay espacio libre en la rotación"
#define D_WEB_SLEEP_ERR_INVALID_SLOT "Espacio de rotación inválido"
#define D_WEB_SLEEP_ERR_SAVE_ROTATION "Fallo al guardar imagen de rotación"
...
#define D_WEB_SLEEP_SLOT_UPLOAD_ERR_FALLBACK "Fallo al subir espacio de rotación"
