...
#define D_WEB_SS_ORDER_LABEL        "Order"
#define D_WEB_SS_CYCLE              "Cycle in list order"
#define D_WEB_SS_SHUFFLE            "Shuffle"
#define D_WEB_SS_USE_SINGLE         "Use single screensaver"
#define D_WEB_SS_USE_MULTI          "Use multiple screensavers"
#define D_WEB_SS_FILES_HEADING      "Screensaver files"
#define D_WEB_SS_ADD_ROTATION       "Add to rotation"
#define D_WEB_SS_REMOVE             "&#10005; Remove"
#define D_WEB_SS_SINGLE_LABEL       "Single custom image"
...
#define D_WEB_SLEEP_ERR_SIZE        "Sleep image must be 3904 bytes or a whole multiple (concatenated frames)"
#define D_WEB_SLEEP_ERR_TOO_MANY_FRAMES "Too many screensaver frames (maximum is 16)"
#define D_WEB_SLEEP_ERR_EMPTY_CHOOSE "Please choose an image first."
#define D_WEB_SLEEP_ERR_ROTATION_SIZE "Rotation image must be exactly 3904 bytes"
#define D_WEB_SLEEP_ERR_NO_FREE_SLOT "No free rotation slot"
#define D_WEB_SLEEP_ERR_INVALID_SLOT "Invalid rotation slot"
#define D_WEB_SLEEP_ERR_SAVE_ROTATION "Failed to save rotation image"
#define D_WEB_SLEEP_ERR_SAVE        "Failed to save sleep image"
#define D_WEB_SLEEP_ERR_ABORTED     "Sleep image upload aborted"
#define D_WEB_SLEEP_SLOT_UPLOAD_ERR_FALLBACK "Sleep slot upload failed"
